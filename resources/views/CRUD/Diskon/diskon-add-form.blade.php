        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('proses-tambah-diskon')}}" method="POST" class="form-container">
                        @csrf

                        <div class="form-group">
                            <label for="name">Nama Diskon:</label>
                            <input type="text" class="form-control" id="name" name="name" placeholder="Nama Diskon" required>
                        </div>

                        <div class="form-group">
                            <label for="name">Persentase Diskon:</label>
                            <input type="number" class="form-control" id="persentase" name="persentase" placeholder="Persentase Diskon" max="90" min="1" required>
                        </div>
